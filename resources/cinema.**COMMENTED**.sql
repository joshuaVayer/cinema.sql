...
CREATE TABLE IF NOT EXISTS Bookings (
    ...
    FOREIGN KEY (Ti_id) REFERENCES Tickets(Ti_id))
    ENGINE=InnoDB DEFAULT CHARACTER SET=utf8;
...
-- 2 - Functions
--------------
  -- Certains UUID are generate manualy has there will be needed for further functions

-- 2.0 - Init (Roles, Prices, Transaction_type)
...
-- 2.1 - Setup companies and facilities
  -- 2.1.1 - Companies
-- New address UUID = 239d9222-3ba7-11ec-b32a-ed49a254bcb5
...
INSERT INTO Companies ("39e78654-3ba8-11ec-b32a-ed49a254bcb5", legal_name, comercial_name, identification_number, A_address_id)
		VALUES(UUID(), "Circuit Georges-Raymond Ouest-Centre S.A", "CGR Ouest-Centre", "120027016", "239d9222-3ba7-11ec-b32a-ed49a254bcb5")
INSERT INTO Companies (C_id, legal_name, comercial_name, identification_number, A_address_id)
  ...
  -- 2.1.2 - Facilities
-- New address UUID = f0e52e8e-3bac-11ec-b32a-ed49a254bcb5
INSERT INTO Addresses (A_id, address1, city, country, postalCode)
...
-- New address UUID = 21589d5a-4060-11ec-af4a-5a35fb4e92f3
INSERT INTO Addresses (A_id, address1, city, country, postalCode)
...
-- New address UUID = de466c66-4061-11ec-af4a-5a35fb4e92f3
INSERT INTO Addresses (A_id, address1, city, country, postalCode)
...
-- New address UUID = ec4aa19c-4061-11ec-af4a-5a35fb4e92f3
...
-- CGR Torcy Marne-la-vallée Rooms
INSERT INTO Rooms (R_id, slots, room_name, active, F_facility_id)
...
-- 2.2 - Setup Movies and Sessions (shows)
  -- 2.2.1 - Movies
INSERT INTO
...
-- 2.2.3 - Bookings
-- Create a new reservation then update the remaining slots
INSERT INTO
...
-- 2.3 - Transactions and Payments

--- NEW TRANSACTION UUID = "f9b9b9b9-6d19-11ec-a473-392613ee6e5f"
INSERT INTO
...
---- Cashed ticket throw internet (wille create a booking)
--- NEW TRANSACTION UUID = "01fe9948-6d22-11ec-a473-392613ee6e5f"
--- NEW TICKET UUID = "76e548f6-6d22-11ec-a473-392613ee6e5f"
INSERT INTO
    Transactions (T_id, TT_type_id)
VALUES
...
INSERT INTO
    Bookings (B_id, book_by, active, cashed, S_show_id, Ti_id)
VALUES
